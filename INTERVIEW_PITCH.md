...
The project is not meant to replace enterprise systems. It is meant to show my operating style. If I see a messy process, I structure the problem, find the data, build a simple tool, and make the team faster.
